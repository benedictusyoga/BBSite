...
export default function Carousel({slides}:{slides:number[]}) {
    ...
    return (
        <div className="carousel-wrapper">
            <img className="border" src="/src/assets/UnionBorder.svg" />
            <div className="button" onClick={prevSlide}>
                <img className="leftButton" src="/src/assets/LeftButton.svg" />
            </div>
            ...
            <div className="button" onClick={nextSlide}>
                <img className="rightButton" src="/src/assets/LeftButton.svg" />
            </div>
        </div>
    )
}